...
namespace Vostok.Logging.Core.Fragments
{
    internal static class FragmentHelpers
    {
        public static object GetPropertyOrNull(LogEvent @event, string propertyName) =>
            @event.Properties == null // TODO(krait): shouldn't @event.Properties return null for nonexistent properties?
                ? null
        ...
        public static T TryParse<T>(string fragmentText, string input, ref int offset) where T : new()
        {
